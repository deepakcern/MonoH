...
#   do FATJet cleaning here
	...
	myCA15PassIDTight=[]
	    ...
	    MassWeight=TheaCorrection_v2(CA15jetP4[ca15jet].Pt(),CA15jetP4[ca15jet].Eta())

	    #print "After mass corr",CA15SDmass[ca15jet]*MassWeight
...
# -------------------------------------------
        ...
        #1e, 1 b-tagged
        if nEle==1 and nMu==0 and nTau==0 and EleCRtrigstatus and WenuRecoil>200. and jetcond and Wenumass > 0. and pfMet > 50.:
        ...
        #1mu, 1 b-tagged
        if nMu==1 and nEle==0 and nTau==0  and MuCRtrigstatus and WmunuRecoil>200. and jetcond and Wmunumass > 0. and pfMet > 50.:
            iLeadLep=0
	...
	TopdPhicond1=True
        ...
        if nEle==1 and nMu==0 and nTau==0 and EleCRtrigstatus and WenuRecoil>200. and jetcond and  Wenumass > 0. and pfMet > 50.:
		    ...
		    allquantities.reg_1e2bT_ca15jet_SD = CA15SD
                    ...
                    allquantities.reg_1e2bT_ntau = nTau
        ...
        if nMu==1 and nEle==0 and nTau==0 and MuCRtrigstatus and WmunuRecoil>200. and jetcond and Wmunumass > 0. and pfMet > 50.:
            ...
            if myMuos[iLeadLep].Pt() > 20. and myMuTightID[iLeadLep] and myMuIso[iLeadLep]<0.15:
	            ...
	            allquantities.reg_1mu2bT_ca15jet_SD = CA15SD
                    ...
                    allquantities.reg_1mu2bT_ntau = nTau
            ...
            if ZeeRecoil>200.:
                ...
                if pfMet > 0.:
                    ...
                    #CR2e2bCutFlow['nlepCond']+=allweights
                                    if nEle==2 and nMu==0 and nTau==0:# and nPho==0:
                        ...
                        if SRFatjetcond:
                            ...
                            if WCond:
                                ...
                                if jetcond:
                                    ...
                                    if nMu==2 and nEle==0 and nTau==0:# and nPho==0:
                        ...
                        if SRFatjetcond:
                            ...
                            if WCond:
                                ...
                                if jetcond:
                                    ...
                                    if nEle==1 and nMu==0 and nTau==0:# and nPho==0:
                        ...
                        if SRFatjetcond:
                            ...
                            if (nJets==0 or nJets ==1):
                                ...
                                if jetcond:
                                    ...
                                    if nEle==0 and nMu==1 and nTau==0:# and nPho==0:
