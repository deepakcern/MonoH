...
def AnalyzeDataSet():
    ...
    cutflownames=['trig','MET','CA15conds','dPhicond','njets','nbjets','jet1','jet2/3','nlep']
    ...
    cutflownamesSR2=['trig','MET','CA15conds','dPhicond','njets','nbjets','jet1','jet2','jet3','nlep']
...
#        if True:
        ...
        # ----------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            CA15Puppi_doublebtag        = skimmedTree.__getattr__('st_ca15doublebtag')
...
#            myTaus.append(tauP4[itau])
        ...
        #---
            ...
            if options.CSV:
                mybJet_disc.append(thinJetCSV[nb])
                if thinJetCSV[nb] > CSVMWP and abs(thinjetP4[nb].Eta())<2.4:
                    mybjets.append(nb)
                    mybJetsP4.append(thinjetP4[nb])

            elif options.DeepCSV:
                mybJet_disc.append(thinJetdeepCSV[nb])
                if thinJetdeepCSV[nb] > DeepCSVMWP and abs(thinjetP4[nb].Eta())<2.4:
                    mybjets.append(nb)
                    mybJetsP4.append(thinjetP4[nb])
...
#        isZeeCR1=False
        ...
        #
        #     if options.CSV:
        #         allquantities.presel_jet1_csv_sr1=mybJet_disc[ifirstjet]
        #         if nJets>1: allquantities.presel_jet2_csv_sr1=mybJet_disc[isecondjet]
        #     if options.DeepCSV:
        #         allquantities.presel_jet1_deepcsv_sr1=mybJet_disc[ifirstjet]
        #         if nJets>1: allquantities.presel_jet2_deepcsv_sr1=mybJet_disc[isecondjet]
        #
        ...
        #
        #     if options.CSV:
        #         allquantities.csv_vs_dPhi_sr1 = [min_dPhi_jet_MET,mybJet_disc[ifirstjet]]
        #     if options.DeepCSV:
        #         allquantities.deepcsv_vs_dPhi_sr1 = [min_dPhi_jet_MET,mybJet_disc[ifirstjet]]
        #     #===
        #
        #
        ...
        #     if options.CSV:
        #        allquantities.jet1_csv_sr1       = mybJet_disc[ifirstjet]
        #     if options.DeepCSV:
        #        allquantities.jet1_deepcsv_sr1   = mybJet_disc[ifirstjet]
        #
        #     if nJets>1:
        ...
        #         if options.CSV:
        #             allquantities.jet2_csv_sr1      = mybJet_disc[isecondjet]
        #         if options.DeepCSV:
        #             allquantities.jet2_deepcsv_sr1  = mybJet_disc[isecondjet]
        #
     ...
     ## for SR2
        ...
        if (nJets == 2 or nJets == 3) and pfmetstatus and SRlepcond and SRtrigstatus and SR2ca15cond:
            ...
            if options.CSV:
                allquantities.presel_jet1_csv_sr2=mybJet_disc[ifirstjet]
                allquantities.presel_jet2_csv_sr2=mybJet_disc[isecondjet]
                if nJets>2: allquantities.presel_jet3_csv_sr2=mybJet_disc[ithirdjet]

            if options.DeepCSV:
                allquantities.presel_jet1_deepcsv_sr2=mybJet_disc[ifirstjet]
                allquantities.presel_jet2_deepcsv_sr2=mybJet_disc[isecondjet]
                if nJets>2: allquantities.presel_jet3_deepcsv_sr2=mybJet_disc[ithirdjet]
            ...
            #===
            if options.CSV:
                csv_ = min(mybJet_disc[ifirstjet],mybJet_disc[isecondjet])
                allquantities.csv_vs_dPhi_sr2 = [min_dPhi_jet_MET,csv_]

            if options.DeepCSV:
                deepcsv_ = min(mybJet_disc[ifirstjet],mybJet_disc[isecondjet])
        ...
        if (nJets == 2 or nJets == 3) and nBjets==2:
            MT_SR=MT(higgspt, pfMet, (pfMetPhi-hbbPhi))
            SR2njetcond=True
        ...
        if SR2_Cut_CA15 and SR2_Cut1_nJets and SR2_Cut2_nBjets and SR2_Cut3_trigstatus and SR2_Cut4_jet1 and SR2_Cut5_jet2 and SR2_Cut6_jet3 and SR2_Cut8_nLep and SR2_Cut9_pfMET and keepevent:
            if Higgsmass > 100. and Higgsmass < 150.:
        ...
        if SR2_Cut_CA15 and SR2_Cut1_nJets and SR2_Cut2_nBjets and SR2_Cut3_trigstatus and SR2_Cut4_jet1 and SR2_Cut5_jet2 and SR2_Cut6_jet3 and SR2_Cut7_dPhi_jet_MET and SR2_Cut8_nLep and SR2_Cut9_pfMET and keepevent:
            ...
            if Higgsmass > 100. and Higgsmass < 150.:
                ...
                if options.CSV:
                   allquantities.jet1_csv_sr2       = mybJet_disc[ifirstjet]
                if options.DeepCSV:
                   allquantities.jet1_deepcsv_sr2   = mybJet_disc[ifirstjet]
                ...
                if options.CSV:
                    allquantities.jet2_csv_sr2      = mybJet_disc[isecondjet]
                if options.DeepCSV:
                    allquantities.jet2_deepcsv_sr2  = mybJet_disc[isecondjet]
                ...
                if nJets>2:
                    ...
                    if options.CSV:
                        allquantities.jet3_csv_sr2       = mybJet_disc[ithirdjet]
                    if options.DeepCSV:
                        allquantities.jet3_deepcsv_sr2   = mybJet_disc[ithirdjet]
...
#            CRCutFlow['nlepcond']+=1
            ...
            if myEles[iLeadLep].Pt() > 30. and myEleTightID[iLeadLep] and myEles[iSecondLep].Pt() > 10. and myEleLooseID[iSecondLep]:
                ...
                #
                #     if options.CSV:
                #         allquantities.reg_2e1b_jet1_csv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_2e1b_jet2_csv = mybJet_disc[isecondjet]
                #     if options.DeepCSV:
                #         allquantities.reg_2e1b_jet1_deepcsv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_2e1b_jet2_deepcsv = mybJet_disc[isecondjet]
                #
            ...
            #2e, 2 b-tagged
                ...
                if nBjets==2 and SR2jet2 and SR2njetcond and ZdPhicond and SR2ca15cond:
                    MT_Zee=MT(higgspt, ZeeRecoil, (ZeePhi-hbbPhi))
                    allquantities.reg_2e2b_MT=MT_Zee
                    ...
                    if options.CSV:
                        allquantities.reg_2e2b_jet1_csv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_2e2b_jet2_csv = mybJet_disc[isecondjet]
                    if options.DeepCSV:
                        allquantities.reg_2e2b_jet1_deepcsv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_2e2b_jet2_deepcsv = mybJet_disc[isecondjet]
...
#            CRCutFlow['nlepcond']+=1
            ...
            if myMuos[iLeadLep].Pt() > 30. and myMuTightID[iLeadLep] and myMuIso[iLeadLep]<0.15 and myMuos[iSecondLep].Pt() > 10. and myMuLooseID[iSecondLep] and myMuIso[iSecondLep]<0.25:
                ...
                #
                #     if options.CSV:
                #         allquantities.reg_2mu1b_jet1_csv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_2mu1b_jet2_csv = mybJet_disc[isecondjet]
                #     if options.DeepCSV:
                #         allquantities.reg_2mu1b_jet1_deepcsv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_2mu1b_jet2_deepcsv = mybJet_disc[isecondjet]
                #
            ...
            #2mu, 2 b-tagged
                ...
                if  nBjets==2 and SR2jet2 and SR2njetcond and ZdPhicond and SR2ca15cond:
                    MT_Zmumu=MT(higgspt, ZmumuRecoil, (ZmumuPhi-hbbPhi))
                    allquantities.reg_2mu2b_MT=MT_Zmumu
                    ...
                    if options.CSV:
                        allquantities.reg_2mu2b_jet1_csv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_2mu2b_jet2_csv = mybJet_disc[isecondjet]

                    if options.DeepCSV:
                        allquantities.reg_2mu2b_jet1_deepcsv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_2mu2b_jet2_deepcsv = mybJet_disc[isecondjet]
...
# -------------------------------------------
        ...
        if nEle==1 and nMu==0 and nTauTightElectron==0 and EleCRtrigstatus and WenuRecoil>200. and jetcond and Wenumass<160. and pfMet > 50.:
            ...
            if myEles[iLeadLep].Pt() > 30. and myEleTightID[iLeadLep]:
                ...
                #     allquantities.reg_1e1bW_njet_n_minus_1=nJets
                #     allquantities.reg_1e1bW_unclean_njet_n_minus_1=nUncleanJets
                #
                # if nBjets==1 and SR1njetcond:
                #     allquantities.reg_1e1bW_min_dPhi_jet_Recoil_n_minus_1 = min( [DeltaPhi(WenuPhi,myJetP4[nb].Phi()) for nb in range(nJets)] )
                #
                # #if nBjets==1 and SR1njetcond and WdPhicond:
                # if  nBjets==1 and WdPhicond and (nJets-nBjets)==0:
                #     allquantities.reg_1e1bW_Wmass = Wenumass
                #     allquantities.reg_1e1bW_WpT=WpT
                #
                #     allquantities.reg_1e1bW_hadrecoil = WenuRecoil
                #     allquantities.reg_1e1bW_MET = pfMet
                #
                #     allquantities.reg_1e1bW_lep1_pT=myEles[iLeadLep].Pt()
                #
                #     allquantities.reg_1e1bW_jet1_pT=j1.Pt()
                #
                #
                #     if nJets>1: allquantities.reg_1e1bW_jet2_pT=j2.Pt()
                #
                #     allquantities.reg_1e1bW_jet1_eta=j1.Eta()
                #     if nJets>1: allquantities.reg_1e1bW_jet2_eta=j2.Eta()
                #
                #     allquantities.reg_1e1bW_jet1_NHadEF=myJetNhadEF[ifirstjet]
                #     allquantities.reg_1e1bW_jet1_CHadEF=myJetChadEF[ifirstjet]
                #     allquantities.reg_1e1bW_jet1_CEmEF=myJetCEmEF[ifirstjet]
                #     allquantities.reg_1e1bW_jet1_PhoEF=myJetPhoEF[ifirstjet]
                #     allquantities.reg_1e1bW_jet1_EleEF=myJetEleEF[ifirstjet]
                #     allquantities.reg_1e1bW_jet1_MuoEF=myJetMuoEF[ifirstjet]
                #
                #     allquantities.regW_1e1b_njet = nJets
                #
                #     if options.CSV:
                #         allquantities.reg_1e1bW_jet1_csv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_1e1bW_jet2_csv = mybJet_disc[isecondjet]
                #
                #         allquantities.reg_1e1bW_min_dR_jet_ele_preclean = min( [DeltaR(myEles[iLeadLep],thinjetP4[nb]) for nb in range(nTHINJets)] )          #For diagnosis
                #
                #     if options.DeepCSV:
                #         allquantities.reg_1e1bW_jet1_deepcsv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_1e1bW_jet2_deepcsv = mybJet_disc[isecondjet]
                #
                #     allquantities.reg_1e1bW_min_dR_jet_ele_postclean = min( [DeltaR(myEles[iLeadLep],myJetP4[nb]) for nb in range(nJets)] )
                #
                #     allquantities.reg_1e1bW_min_dPhi_jet_Recoil = min( [DeltaPhi(WenuPhi,myJetP4[nb].Phi()) for nb in range(nJets)] )
                #     allquantities.reg_1e1bW_min_dPhi_jet_MET = min( [DeltaPhi(pfMetPhi,myJetP4[nb].Phi()) for nb in range(nJets)] )
                #
                #     allquantities.reg_1e1bW_ntau = nTauTightElectron
                #     allquantities.reg_1e1bW_nele = nEle
                #     allquantities.reg_1e1bW_nmu = nMu
                #     allquantities.reg_1e1bW_nUncleanTau = nUncleanTau
                #     allquantities.reg_1e1bW_nUncleanEle = nUncleanEle
                #     allquantities.reg_1e1bW_nUncleanMu = nUncleanMu
                #     allquantities.lep_syst_1e1bW_up = WenuRecoil
                #     allquantities.lep_syst_1e1bW_down = WenuRecoil
                #     allquantities.btag_syst_1e1bW_up = WenuRecoil
                #     allquantities.btag_syst_1e1bW_down = WenuRecoil
                #     allquantities.metTrig_syst_1e1bW_up =WenuRecoil
                #     allquantities.metTrig_syst_1e1bW_down =WenuRecoil
                #     allquantities.ewkZ_syst_1e1bW_up = WenuRecoil
                #     allquantities.ewkZ_syst_1e1bW_down = WenuRecoil
                #     allquantities.ewkW_syst_1e1bW_up = WenuRecoil
                #     allquantities.ewkW_syst_1e1bW_down = WenuRecoil
                #     allquantities.ewkTop_syst_1e1bW_up = WenuRecoil
                #     allquantities.ewkTop_syst_1e1bW_down = WenuRecoil
                #     allquantities.pho_syst_1e1bW_up = WenuRecoil
                #     allquantities.pho_syst_1e1bW_down = WenuRecoil
                #     allquantities.jec_syst_1e1bW_up = WenuRecoil
                #     allquantities.jec_syst_1e1bW_down = WenuRecoil
                #     allquantities.jer_syst_1e1bW_up = WenuRecoil
                #     allquantities.jer_syst_1e1bW_down = WenuRecoil
                #     isWenuCR1 = True
            ...
            #1e, 2 b-tagged
                ...
                if nBjets==2 and SR2jet2 and WCond and WdPhicond and SR2ca15cond:
                    MT_We=MT(higgspt, WenuRecoil, (WenuPhi-hbbPhi))
                    allquantities.reg_1e2bW_MT = MT_We
                    ...
                    if options.CSV:
                        allquantities.reg_1e2bW_jet1_csv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1e2bW_jet2_csv = mybJet_disc[isecondjet]
                    ...
                    if options.DeepCSV:
                        allquantities.reg_1e2bW_jet1_deepcsv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1e2bW_jet2_deepcsv = mybJet_disc[isecondjet]
                    ...
                    allquantities.pho_syst_1e2bW_up = WenuRecoil
                    allquantities.pho_syst_1e2bW_down = WenuRecoil
                    allquantities.jec_syst_1e2bW_up = WenuRecoil
                    allquantities.jec_syst_1e2bW_down = WenuRecoil
                    allquantities.jer_syst_1e2bW_up = WenuRecoil
                    allquantities.jer_syst_1e2bW_down = WenuRecoil
                    isWenuCR2 = True
        ...
        if nMu==1 and nEle==0 and nTauTightMuon==0 and MuCRtrigstatus and WmunuRecoil>200. and jetcond and Wmunumass<160. and pfMet > 50.:
            ...
            if myMuos[iLeadLep].Pt() > 30. and myMuTightID[iLeadLep] and myMuIso[iLeadLep]<0.15:
                ...
                #
                #     if options.CSV:
                #         allquantities.reg_1mu1b_jet1_csv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_1mu1b_jet2_csv = mybJet_disc[isecondjet]
                #
                #     if options.DeepCSV:
                #         allquantities.reg_1mu1b_jet1_deepcsv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_1mu1b_jet2_deepcsv = mybJet_disc[isecondjet]
                #
            ...
            #1mu, 2 b-tagged
                ...
                if  nBjets==2 and SR2jet2 and WCond and WdPhicond and SR2ca15cond:
                    MT_Wmu=MT(higgspt, WmunuRecoil, (WmunuPhi-hbbPhi))
                    allquantities.reg_1mu2bW_MT = MT_Wmu
                    ...
                    if options.CSV:
                        allquantities.reg_1mu2Wb_jet1_csv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1mu2bW_jet2_csv = mybJet_disc[isecondjet]

                    if options.DeepCSV:
                        allquantities.reg_1mu2bW_jet1_deepcsv = mybJet_disc[ifirstjet]
                        if nJets>1: allquantities.reg_1mu2bW_jet2_deepcsv = mybJet_disc[isecondjet]
                    ...
                    allquantities.pho_syst_1mu2bW_up = WmunuRecoil
                    allquantities.pho_syst_1mu2bW_down = WmunuRecoil
                    allquantities.jec_syst_1mu2bW_up = WmunuRecoil
                    allquantities.jec_syst_1mu2bW_down = WmunuRecoil
                    allquantities.jer_syst_1mu2bW_up = WmunuRecoil
                    allquantities.jer_syst_1mu2bW_down = WmunuRecoil
                    isWmunuCR2 = True
...
# -------------------------------------------
        ...
        if nEle==1 and nMu==0 and nTauTightElectron==0 and EleCRtrigstatus and WenuRecoil>200. and jetcond and Wenumass<160. and pfMet > 50.:
            ...
            if myEles[iLeadLep].Pt() > 30. and myEleTightID[iLeadLep]:
                ...
                #
                # if nBjets==1 and WdPhicond :
                #     allquantities.reg_1e1bT_njet_n_minus_1=nJets
                #     allquantities.reg_1e1bT_unclean_njet_n_minus_1=nUncleanJets
                #
                # if nBjets==1 and SR1njetcond:
                #     allquantities.reg_1e1bT_min_dPhi_jet_Recoil_n_minus_1 = min( [DeltaPhi(WenuPhi,myJetP4[nb].Phi()) for nb in range(nJets)] )
                #
                # #if nBjets==1 and SR1njetcond and WdPhicond:
                # if  nBjets==1 and WdPhicond and (nJets-nBjets)>=1:
                #     allquantities.reg_1e1bT_Wmass = Wenumass
                #     allquantities.reg_1e1bT_WpT=WpT
                #
                #     allquantities.reg_1e1bT_hadrecoil = WenuRecoil
                #     allquantities.reg_1e1bT_MET = pfMet
                #
                #     allquantities.reg_1e1bT_lep1_pT=myEles[iLeadLep].Pt()
                #
                #     allquantities.reg_1e1bT_jet1_pT=j1.Pt()
                #
                #
                #     if nJets>1: allquantities.reg_1e1bT_jet2_pT=j2.Pt()
                #
                #     allquantities.reg_1e1bT_jet1_eta=j1.Eta()
                #     if nJets>1: allquantities.reg_1e1bT_jet2_eta=j2.Eta()
                #
                #     allquantities.reg_1e1bT_jet1_NHadEF=myJetNhadEF[ifirstjet]
                #     allquantities.reg_1e1bT_jet1_CHadEF=myJetChadEF[ifirstjet]
                #     allquantities.reg_1e1bT_jet1_CEmEF=myJetCEmEF[ifirstjet]
                #     allquantities.reg_1e1bT_jet1_PhoEF=myJetPhoEF[ifirstjet]
                #     allquantities.reg_1e1bT_jet1_EleEF=myJetEleEF[ifirstjet]
                #     allquantities.reg_1e1bT_jet1_MuoEF=myJetMuoEF[ifirstjet]
                #
                #     allquantities.reg_1e1bT_njet = nJets
                #
                #     if options.CSV:
                #         allquantities.reg_1e1bT_jet1_csv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_1e1bT_jet2_csv = mybJet_disc[isecondjet]
                #
                #         allquantities.reg_1e1bT_min_dR_jet_ele_preclean = min( [DeltaR(myEles[iLeadLep],thinjetP4[nb]) for nb in range(nTHINJets)] )          #For diagnosis
                #
                #     if options.DeepCSV:
                #         allquantities.reg_1e1bT_jet1_deepcsv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_1e1bT_jet2_deepcsv = mybJet_disc[isecondjet]
                #
                #     allquantities.reg_1e1bT_min_dR_jet_ele_postclean = min( [DeltaR(myEles[iLeadLep],myJetP4[nb]) for nb in range(nJets)] )
                #
                #     allquantities.reg_1e1bT_min_dPhi_jet_Recoil = min( [DeltaPhi(WenuPhi,myJetP4[nb].Phi()) for nb in range(nJets)] )
                #     allquantities.reg_1e1bT_min_dPhi_jet_MET = min( [DeltaPhi(pfMetPhi,myJetP4[nb].Phi()) for nb in range(nJets)] )
                #
                #     allquantities.reg_1e21bT_ntau = nTauTightElectron
                #     allquantities.reg_1e1bT_nele = nEle
                #     allquantities.reg_1e1bT_nmu = nMu
                #     allquantities.reg_1e1bT_nUncleanTau = nUncleanTau
                #     allquantities.reg_1e1bT_nUncleanEle = nUncleanEle
                #     allquantities.reg_1e1bT_nUncleanMu = nUncleanMu
                #     allquantities.lep_syst_1e1bT_up = WenuRecoil
                #     allquantities.lep_syst_1e1bT_down = WenuRecoil
                #     allquantities.btag_syst_1e1bT_up = WenuRecoil
                #     allquantities.btag_syst_1e1bT_down = WenuRecoil
                #     allquantities.metTrig_syst_1e1bT_up =WenuRecoil
                #     allquantities.metTrig_syst_1e1bT_down =WenuRecoil
                #     allquantities.ewkZ_syst_1e1bT_up = WenuRecoil
                #     allquantities.ewkZ_syst_1e1bT_down = WenuRecoil
                #     allquantities.ewkW_syst_1e1bT_up = WenuRecoil
                #     allquantities.ewkW_syst_1e1bT_down = WenuRecoil
                #     allquantities.ewkTop_syst_1e1bT_up = WenuRecoil
                #     allquantities.ewkTop_syst_1e1bT_down = WenuRecoil
                #     allquantities.pho_syst_1e1bT_up = WenuRecoil
                #     allquantities.pho_syst_1e1bT_down = WenuRecoil
                #     allquantities.jec_syst_1e1bT_up = WenuRecoil
                #     allquantities.jec_syst_1e1bT_down = WenuRecoil
                #     allquantities.jer_syst_1e1bT_up = WenuRecoil
                #     allquantities.jer_syst_1e1bTb_down = WenuRecoil
                #     isTopenuCR1 = True
            ...
            #1e, 2 b-tagged
                ...
                if nBjets==2 and SR2jet2 and TopCond and WdPhicond and SR2ca15cond:
                    MT_We=MT(higgspt, WenuRecoil, (WenuPhi-hbbPhi))
                    allquantities.reg_1e2bT_MT = MT_We
                    ...
                    if Higgsmass > 100. and Higgsmass < 150.:
                        ...
                        if options.CSV:
                            allquantities.reg_1e2bT_jet1_csv = mybJet_disc[ifirstjet]
                            if nJets>1: allquantities.reg_1e2bT_jet2_csv = mybJet_disc[isecondjet]
                        ...
                        if options.DeepCSV:
                            allquantities.reg_1e2bT_jet1_deepcsv = mybJet_disc[ifirstjet]
                            if nJets>1: allquantities.reg_1e2bT_jet2_deepcsv = mybJet_disc[isecondjet]
                        ...
                        allquantities.pho_syst_1e2bT_up = WenuRecoil
                        allquantities.pho_syst_1e2bT_down = WenuRecoil
                        allquantities.jec_syst_1e2bT_up = WenuRecoil
                        allquantities.jec_syst_1e2bT_down = WenuRecoil
                        allquantities.jer_syst_1e2bT_up = WenuRecoil
                        allquantities.jer_syst_1e2bT_down = WenuRecoil
                        isTopenuCR2 = True
        ...
        if nMu==1 and nEle==0 and nTauTightMuon==0 and MuCRtrigstatus and WmunuRecoil>200. and jetcond and Wmunumass<160. and pfMet > 50.:
            ...
            if myMuos[iLeadLep].Pt() > 30. and myMuTightID[iLeadLep] and myMuIso[iLeadLep]<0.15:
                ...
                # if nBjets==1 and WdPhicond:
                #     allquantities.reg_1mu1bT_njet_n_minus_1=nJets
                #     allquantities.reg_1mu1bT_unclean_njet_n_minus_1=nUncleanJets
                #
                # if  nBjets==1 and SR1njetcond:
                #     allquantities.reg_1mu1bT_min_dPhi_jet_Recoil_n_minus_1 = min( [DeltaPhi(WmunuPhi,myJetP4[nb].Phi()) for nb in range(nJets)] )
                #
                # #if  nBjets==1 and SR1njetcond and WdPhicond:
                # if  nBjets==1 and WdPhicond and (nJets-nBjets)>=1:
                #     allquantities.reg_1mu1bT_Wmass = Wmunumass
                #     allquantities.reg_1mu1bT_WpT=WpT
                #
                #     allquantities.reg_1mu1bT_hadrecoil = WmunuRecoil
                #     allquantities.reg_1mu1bT_MET = pfMet
                #
                #     allquantities.reg_1mu1bT_lep1_pT=myMuos[iLeadLep].Pt()
                #     allquantities.reg_1mu1bT_lep1_iso=myMuIso[iLeadLep]
                #
                #     allquantities.reg_1mu1bT_jet1_pT=j1.Pt()
                #
                #     if nJets>1: allquantities.reg_1mu1bT_jet2_pT=j2.Pt()
                #
                #     allquantities.reg_1mu1bT_jet1_eta=j1.Eta()
                #     if nJets>1: allquantities.reg_1mu1bT_jet2_eta=j2.Eta()
                #
                #     allquantities.reg_1mu1bT_jet1_NHadEF=myJetNhadEF[ifirstjet]
                #     allquantities.reg_1mu1bT_jet1_CHadEF=myJetChadEF[ifirstjet]
                #     allquantities.reg_1mu1bT_jet1_CEmEF=myJetCEmEF[ifirstjet]
                #     allquantities.reg_1mu1bT_jet1_PhoEF=myJetPhoEF[ifirstjet]
                #     allquantities.reg_1mu1bT_jet1_EleEF=myJetEleEF[ifirstjet]
                #     allquantities.reg_1mu1bT_jet1_MuoEF=myJetMuoEF[ifirstjet]
                #
                #     allquantities.reg_1mu1bT_njet = nJets
                #
                #     if options.CSV:
                #         allquantities.reg_1mu1bT_jet1_csv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_1mu1bT_jet2_csv = mybJet_disc[isecondjet]
                #
                #     if options.DeepCSV:
                #         allquantities.reg_1mu1bT_jet1_deepcsv = mybJet_disc[ifirstjet]
                #         if nJets>1: allquantities.reg_1mu1bT_jet2_deepcsv = mybJet_disc[isecondjet]
                #
                #     allquantities.reg_1mu1bT_min_dPhi_jet_Recoil = min( [DeltaPhi(WmunuPhi,myJetP4[nb].Phi()) for nb in range(nJets)] )
                #     allquantities.reg_1mu1bT_min_dPhi_jet_MET = min( [DeltaPhi(pfMetPhi,myJetP4[nb].Phi()) for nb in range(nJets)] )
                #
                #     allquantities.reg_1mu1bT_ntau = nTauTightMuon
                #     allquantities.reg_1mu1bT_nele = nEle
                #     allquantities.reg_1mu1bT_nmu = nMu
                #     allquantities.reg_1mu1bT_nUncleanTau = nUncleanTau
                #     allquantities.reg_1mu1bT_nUncleanEle = nUncleanEle
                #     allquantities.reg_1mu1bT_nUncleanMu = nUncleanMu
                #     allquantities.lep_syst_1mu1bT_up = WmunuRecoil
                #     allquantities.lep_syst_1mu1bT_down = WmunuRecoil
                #     allquantities.btag_syst_1mu1bT_up = WmunuRecoil
                #     allquantities.btag_syst_1mu1bT_down = WmunuRecoil
                #     allquantities.metTrig_syst_1mu1bT_up = WmunuRecoil
                #     allquantities.metTrig_syst_1mu1bT_down = WmunuRecoil
                #     allquantities.ewkZ_syst_1mu1bT_up = WmunuRecoil
                #     allquantities.ewkZ_syst_1mu1bT_down = WmunuRecoil
                #     allquantities.ewkW_syst_1mu1bT_up = WmunuRecoil
                #     allquantities.ewkW_syst_1mu1bT_down = WmunuRecoil
                #     allquantities.ewkTop_syst_1mu1bT_up = WmunuRecoil
                #     allquantities.ewkTop_syst_1mu1bT_down = WmunuRecoil
                #     allquantities.pho_syst_1mu1bT_up = WmunuRecoil
                #     allquantities.pho_syst_1mu1bT_down = WmunuRecoil
                #     allquantities.jec_syst_1mu1bT_up = WmunuRecoil
                #     allquantities.jec_syst_1mu1bT_down = WmunuRecoil
                #     allquantities.jer_syst_1mu1bT_up = WmunuRecoil
                #     allquantities.jer_syst_1mu1bT_down = WmunuRecoil
                #     isTopmunuCR1 = True
            ...
            #1mu, 2 b-tagged
                ...
                if nBjets==2 and SR2jet2 and TopCond and WdPhicond and SR2ca15cond:
                    MT_We=MT(higgspt, WmunuRecoil, (WmunuPhi-hbbPhi))
                    allquantities.reg_1e2bT_MT = MT_We
                    ...
                    if Higgsmass > 100. and Higgsmass < 150.:
                        ...
                        if options.CSV:
                            allquantities.reg_1mu2bT_jet1_csv = mybJet_disc[ifirstjet]
                            if nJets>1: allquantities.reg_1mu2bT_jet2_csv = mybJet_disc[isecondjet]

                        if options.DeepCSV:
                            allquantities.reg_1mu2bT_jet1_deepcsv = mybJet_disc[ifirstjet]
                            if nJets>1: allquantities.reg_1mu2bT_jet2_deepcsv = mybJet_disc[isecondjet]
                        ...
                        allquantities.pho_syst_1mu2bT_up = WmunuRecoil
                        allquantities.pho_syst_1mu2bT_down = WmunuRecoil
                        allquantities.jec_syst_1mu2bT_up = WmunuRecoil
                        allquantities.jec_syst_1mu2bT_down = WmunuRecoil
                        allquantities.jer_syst_1mu2bT_up = WmunuRecoil
                        allquantities.jer_syst_1mu2bT_down = WmunuRecoil
                        isTopmunuCR2 = True
...
#
#                     if options.CSV:
#                         allquantities.reg_1mu1e1b_jet1_csv = mybJet_disc[ifirstjet]
#                         if nJets>1: allquantities.reg_1mu1e1b_jet2_csv = mybJet_disc[isecondjet]
#
#                     if options.DeepCSV:
#                         allquantities.reg_1mu1e1b_jet1_deepcsv = mybJet_disc[ifirstjet]
#                         if nJets>1: allquantities.reg_1mu1e1b_jet2_deepcsv = mybJet_disc[isecondjet]
#
...
#
#                     if options.CSV:
#                         allquantities.reg_1mu1e2b_jet1_csv = mybJet_disc[ifirstjet]
#                         if nJets>1: allquantities.reg_1mu1e2b_jet2_csv = mybJet_disc[isecondjet]
#
#                     if options.DeepCSV:
#                         allquantities.reg_1mu1e2b_jet1_deepcsv = mybJet_disc[ifirstjet]
#                         if nJets>1: allquantities.reg_1mu1e2b_jet2_deepcsv = mybJet_disc[isecondjet]
#
...
#
#                     if options.CSV:
#                         allquantities.reg_1gamma1b_jet1_csv = mybJet_disc[ifirstjet]
#                         if nJets>1: allquantities.reg_1gamma1b_jet2_csv = mybJet_disc[isecondjet]
#
#                     if options.DeepCSV:
#                         allquantities.reg_1gamma1b_jet1_deepcsv = mybJet_disc[ifirstjet]
#                         if nJets>1: allquantities.reg_1gamma1b_jet2_deepcsv = mybJet_disc[isecondjet]
#
...
#
#                     if options.CSV:
#                         allquantities.reg_1gamma2b_jet1_csv = mybJet_disc[ifirstjet]
#                         if nJets>1: allquantities.reg_1gamma2b_jet2_csv = mybJet_disc[isecondjet]
#
#                     if options.DeepCSV:
#                         allquantities.reg_1gamma2b_jet1_deepcsv = mybJet_disc[ifirstjet]
#                         if nJets>1: allquantities.reg_1gamma2b_jet2_deepcsv = mybJet_disc[isecondjet]
#
...
#                     isGammaCR2 = True
        ...
        #
        #     if options.CSV:
        #         allquantities.reg_QCD1b_jet1_csv    =   mybJet_disc[ifirstjet]
        #         if nJets>1: allquantities.reg_QCD1b_jet2_csv    = mybJet_disc[isecondjet]
        #     if options.DeepCSV:
        #         allquantities.reg_QCD1b_jet1_deepcsv    =   mybJet_disc[ifirstjet]
        #         if nJets>1: allquantities.reg_QCD1b_jet2_deepcsv    = mybJet_disc[isecondjet]
        #
        ...
        if QCD2b_Cut_CA15 and QCD2b_Cut1_nJets and QCD2b_Cut3_trigstatus and QCD2b_Cut8_nLep and QCD2b_Cut9_pfMET:
        ...
        if QCD2b_Cut_CA15 and QCD2b_Cut1_nJets and QCD2b_Cut2_nBjets and QCD2b_Cut3_trigstatus and QCD2b_Cut4_jet1 and QCD2b_Cut5_jet2 and QCD2b_Cut6_jet3 and QCD2b_Cut7_dPhi_jet_MET and QCD2b_Cut8_nLep and QCD2b_Cut9_pfMET:
            MT_QCD=MT(higgspt, pfMet, (pfMetPhi-hbbPhi))

            allquantities.reg_QCD2b_MT         =   MT_QCD
            ...
            if options.CSV:
                allquantities.reg_QCD2b_jet1_csv    =   mybJet_disc[ifirstjet]
                allquantities.reg_QCD2b_jet2_csv    = mybJet_disc[isecondjet]
            if options.DeepCSV:
                allquantities.reg_QCD2b_jet1_deepcsv    =   mybJet_disc[ifirstjet]
                allquantities.reg_QCD2b_jet2_deepcsv    = mybJet_disc[isecondjet]
                ...
                if SR2ca15cond:
                    ...
                    if pfMet > 0.:
                        ...
                        if ZeeMass>70. and ZeeMass<110.:
                            # CR2e1bCutFlow['Zmass']+=allweights
                ...
                if pfMet > 0.:
                    ...
                    if SR2ca15cond:
                        ...
                        if ZmumuMass>70. and ZmumuMass<110.:
                            # CR2mu1bCutFlow['Zmass']+=allweights
